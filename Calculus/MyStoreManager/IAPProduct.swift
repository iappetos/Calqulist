...
//  Calqulist
//
//  Created by Ioannis Karagogoson 2/1/20.
...
struct myProductList {
    static let calqulistPro : String = "com.ikaragogos.Calqulist.CalqulistPro"
    static let arrayOfProducts = [calqulistPro]
...
switch product {
case myProductList.calqulistPro: deliverNonconsumable(identifier: myProductList.calqulistPro)
      break
default: break
}
}//Func
...
static func isProductAvailable(identifier: String) -> Bool {
    ...
    static func updateFromiCloud() {
       // let latestExtraTrials = NSUbiquitousKeyValueStore.default.double(forKey: myProductList.extraTrials)
        let latestUnlimited = NSUbiquitousKeyValueStore.default.bool(forKey: myProductList.calqulistPro)
        
        // KeychainWrapper.standard.set(latestExtraTrials, forKey: myProductList.extraTrials)
         KeychainWrapper.standard.set(latestUnlimited, forKey: myProductList.calqulistPro)
    }
